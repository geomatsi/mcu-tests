...
fn main() -> ! {
    ...
    let pwm = {
        ...
        p.TIM2
            .pwm_hz::<Tim2NoRemap, _, _>((p1, p2, p3, p4), &mut afio.mapr, 10.kHz(), &mut rcc)
    };
    ...
    let pwm = {
        ...
        p.TIM2.pwm_hz::<Tim2PartialRemap1, _, _>(
            (p1, p2, p3, p4),
            &mut afio.mapr,
            10.kHz(),
            &mut rcc,
    ...
    let pwm = {
        ...
        p.TIM2.pwm_hz::<Tim2PartialRemap2, _, _>(
            (p1, p2, p3, p4),
            &mut afio.mapr,
            10.kHz(),
            &mut rcc,
    ...
    let pwm = {
        ...
        p.TIM2
            .pwm_hz::<Tim2FullRemap, _, _>((p1, p2, p3, p4), &mut afio.mapr, 10.kHz(), &mut rcc)
    };
    ...
    let pwm = {
        ...
        p.TIM3
            .pwm_hz::<Tim3NoRemap, _, _>((p1, p2, p3, p4), &mut afio.mapr, 10.kHz(), &mut rcc)
    };
    ...
    let pwm = {
        ...
        p.TIM3.pwm_hz::<Tim3PartialRemap, _, _>(
            (p1, p2, p3, p4),
            &mut afio.mapr,
            10.kHz(),
            &mut rcc,
    ...
    let pwm = {
        ...
        p.TIM4
            .pwm_hz::<Tim4NoRemap, _, _>((p1, p2, p3, p4), &mut afio.mapr, 10.kHz(), &mut rcc)
    };
    ...
    let _ = hprintln!("PWM max duty {}, duty {}", max, duty);
